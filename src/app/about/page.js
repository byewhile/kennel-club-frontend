        ...
        <main className="container mx-auto px-6 lg:px-12 py-10">
            ...
            <div className="flex flex-col gap-3 my-10">
                <details className="cursor-pointer">
                    <summary className="p-4 text-lg font-bold bg-green text-white">1999 – Основание клуба собаководства</summary>
                ...
                <details className="cursor-pointer">
                    <summary className="p-4 text-lg font-bold bg-green text-white">2000–2005 – Первые выставки и тренировки</summary>
                ...
                <details className="cursor-pointer">
                    <summary className="p-4 text-lg font-bold bg-green text-white">2006–2015 - Расширение деятельности</summary>
                ...
                <details className="cursor-pointer">
                    <summary className="p-4 text-lg font-bold bg-green text-white">2016–2025 - Современный этап</summary>
                    <ul className="py-2 text-lg text-gray-600 list-disc list-inside">
